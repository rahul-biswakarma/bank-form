...
const BankDetailsForm = ({
  ...
  useEffect(() => {
    ...
    if (businessFormInformation.ifscCode)
      ifscCodeRef.current.value = businessFormInformation.ifscCode;
    if (businessFormInformation.accountNumber)
      accNumberRef.current.value = businessFormInformation.accountNumber;
  }, []);
